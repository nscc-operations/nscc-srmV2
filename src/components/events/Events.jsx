    ...
    <main className="events-section relative">
      ...
      <div className="live-events-header-mobile relative z-10">
        ...
        <p className="live-events-description-mobile">
          Our events are all about energy, innovation, and community. From
          coding marathons to idea showcases, we create platforms where students
          challenge themselves, collaborate with peers, and celebrate
          technology. Each event is designed to spark creativity, build skills,
